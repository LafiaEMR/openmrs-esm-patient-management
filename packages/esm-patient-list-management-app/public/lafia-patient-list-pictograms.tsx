...
const LafiaPatientListPictogram = (props: any) => (
  <svg width="72" height="72" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect width="36" height="36" fill="white" fill-opacity="0.01" style={{ mixBlendMode: 'multiply' }} />
...
export default LafiaPatientListPictogram;
